...
-- preset keybindings.
myLauncher = "rofi -show run -font \"UbuntuMono Nerd Font 12\""
...
codeWs  = "3: \xf3bd"
mediaWs = "4: \xf167"
myWorkspaces = [ termWs, webWs, codeWs, mediaWs] ++ map show [5..9]
...
addSpace     = spacingRaw True (Border 0 0 0 0) True (Border 10 10 10 10) True
tab          =  avoidStruts
               $ addTopBar
               $ myGaps
...
xmobarTitleColor = orange --"#C678DD"

-- Color of current workspace in xmobar.
xmobarCurrentWorkspaceColor = orange --"#51AFEF"

-- Width of the window border in pixels.
myBorderWidth = 1

myNormalBorderColor     = "#000000" --inactive
myFocusedBorderColor    = "#005577" --active
...
myFont      = "xft:UbuntuMono Nerd Font:size=12:antialias=true"
myBigFont   = "xft:UbuntuMono Nerd Font:size=12:bold:antialias=true"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  ++
  -- resize floating window using kb
  [
    ((modMask .|. shiftMask, xK_d ), withFocused (keysResizeWindow (10,10) (0,0)))
  , ((modMask .|. shiftMask, xK_s ), withFocused (keysResizeWindow (-10,-10) (0, 0)))
  --, ((modMask .|. shiftMask, xK_a ), withFocused (keysMoveWindow (10,10)))
  ]
------------------------------------------------------------------------
-- Mouse bindings
--
